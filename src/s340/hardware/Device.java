...
public abstract class Device implements Runnable
{
	...
	public Device(int deviceNumber, InterruptRegisters interruptRegisters, DeviceControlRegister controlRegisters)

	{
		this(deviceNumber, interruptRegisters, controlRegisters, null);
	}
